...
/**
 * Initialize the 360° photo viewer
 * @param {Object} config
 * @param {string} config.container - Container element ID
 * @param {string[]} config.photos - Array of photo paths
 * @param {string} [config.thumbnailStrip] - Thumbnail strip element ID
 */
